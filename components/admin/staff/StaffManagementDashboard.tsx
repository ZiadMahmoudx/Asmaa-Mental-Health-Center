    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          ...
          <p className="text-[11px] text-slate-500 font-bold">إجمالي الأطباء</p>
          <p className="text-xl font-black text-slate-900">{doctors.length}</p>
        </div>

        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          <CheckCircle2 className="w-4 h-4 text-emerald-600" />
          <p className="text-[11px] text-slate-500 font-bold">يستقبلون حجوزات</p>
        ...
        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          ...
          <p className="text-[11px] text-slate-500 font-bold">طاقم الإدارة والاستقبال</p>
          <p className="text-xl font-black text-slate-900">{admins.length}</p>
        </div>

        <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-1">
          <CalendarClock className="w-4 h-4 text-amber-600" />
          <p className="text-[11px] text-slate-500 font-bold">إجمالي فترات العمل</p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-white border border-slate-200 rounded-2xl shadow-sm">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-3 pr-9 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900"
          />
        </div>
      </div>
