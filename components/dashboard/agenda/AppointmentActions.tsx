    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {isConfirmed && isPast && (
        <form action={completeAction}>
          ...
          <button
            ...
            className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition inline-flex items-center gap-1 shadow-sm disabled:opacity-50"
          >
      ...
      {isConfirmed && (
        <button
          ...
          className="px-3 py-1.5 border border-slate-300 dark:border-slate-700 hover:border-teal-500 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-semibold transition inline-flex items-center gap-1"
        >
      ...
      {appointment.type === "ONLINE" && isConfirmed && (
        <button
          ...
          className="px-3 py-1.5 border border-slate-300 dark:border-slate-700 hover:border-blue-500 text-blue-600 dark:text-blue-400 rounded-xl text-xs font-semibold transition inline-flex items-center gap-1"
        >
      ...
      {isConfirmed && (
        <button
          ...
          className="px-3 py-1.5 text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-xl text-xs font-semibold transition inline-flex items-center gap-1"
        >
